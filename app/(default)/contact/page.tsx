export const metadata = {
  title: "Contact us - AI Course Creation CoPilot",
            ...
            <div className="w-full max-w-xs mx-auto shrink-0">
              ...
              >
                <input
                  type="hidden"
                  name="access_key"
                  value="40a2faae-46d2-412f-9cb3-9004864bd9be"
                />
                  ...
                  <div className="space-y-3">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        id="message"
                        name="message"
                        className="w-full h-24 px-3 py-2 text-sm align-top resize-none form-input"
            ...
            <div className="grid gap-6 md:grid-cols-3 xl:gap-9 xl:mx-8 max-md:-mx-3">
              ...
              <div className="flex flex-col p-5 rounded-lg bg-gradient-to-tr from-white/70 to-white/50 dark:bg-gradient-to-b dark:from-gray-700/50 dark:to-gray-700/40">
                <div className="mb-3 grow">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-500">
                    Prefer to visit? We're located in Paris, France.
                  </p>
                </div>
                <div className="flex items-center space-x-2.5">
                  <svg
